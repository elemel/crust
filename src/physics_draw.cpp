...
namespace crust {
    ...
    void PhysicsDraw::DrawPolygon(b2Vec2 const *vertices, int32 vertexCount,
                                  b2Color const &color)
    {
    ...
    void PhysicsDraw::DrawSolidPolygon(b2Vec2 const *vertices, int32 vertexCount,
                                       b2Color const &color)
    {
        DrawPolygon(vertices, vertexCount, color);
    }
    
    void PhysicsDraw::DrawCircle(b2Vec2 const &center, float32 radius,
                                 b2Color const &color)
    {
        glBegin(GL_LINE_LOOP);
    ...
    void PhysicsDraw::DrawSolidCircle(b2Vec2 const &center, float32 radius,
    ...
    void PhysicsDraw::DrawSegment(b2Vec2 const &p1, b2Vec2 const &p2,
                                  b2Color const &color)
        {
